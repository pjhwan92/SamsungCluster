export SPARK_CLASSPATH="/home/arcs/fr/alluxio-1.3.0/core/client/target/alluxio-core-client-1.3.0-jar-with-dependencies.jar:/home/arcs/fr/alluxio/conf:${SPARK_CLASSPATH}"
