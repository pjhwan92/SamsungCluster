              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.persistedFiles = new ArrayList<Long>(_list140.size);
                  long _elem141;
                  for (int _i142 = 0; _i142 < _list140.size; ++_i142)
                  {
                    _elem141 = iprot.readI64();
                    struct.persistedFiles.add(_elem141);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.persistedFiles != null) {
          oprot.writeFieldBegin(PERSISTED_FILES_FIELD_DESC);
          {
            ...
            for (long _iter143 : struct.persistedFiles)
            {
        ...
        if (struct.isSetPersistedFiles()) {
          {
            ...
            for (long _iter144 : struct.persistedFiles)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.persistedFiles = new ArrayList<Long>(_list145.size);
            long _elem146;
            for (int _i147 = 0; _i147 < _list145.size; ++_i147)
            {
              _elem146 = iprot.readI64();
              struct.persistedFiles.add(_elem146);
            }
          }
          struct.setPersistedFilesIsSet(true);
        }
