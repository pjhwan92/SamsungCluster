...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-08-04")
public class BlockMasterWorkerService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * 
     * @param prefetchedBlockIds prefetch complete list
     */
  ...
  public static class heartbeat_args implements org.apache.thrift.TBase<heartbeat_args, heartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_args>   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.prefetchedBlockIds = new ArrayList<Long>(_list30.size);
                  long _elem31;
                  for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                  {
                    _elem31 = iprot.readI64();
                    struct.prefetchedBlockIds.add(_elem31);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usedBytesOnTiers != null) {
          oprot.writeFieldBegin(USED_BYTES_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter33 : struct.usedBytesOnTiers.entrySet())
            {
        ...
        if (struct.removedBlockIds != null) {
          oprot.writeFieldBegin(REMOVED_BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter34 : struct.removedBlockIds)
            {
        ...
        if (struct.addedBlocksOnTiers != null) {
          oprot.writeFieldBegin(ADDED_BLOCKS_ON_TIERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, List<Long>> _iter35 : struct.addedBlocksOnTiers.entrySet())
            {
              oprot.writeString(_iter35.getKey());
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter35.getValue().size()));
        ...
        if (struct.prefetchedBlockIds != null) {
          oprot.writeFieldBegin(PREFETCHED_BLOCK_IDS_FIELD_DESC);
          {
            ...
            for (long _iter37 : struct.prefetchedBlockIds)
            {
    ...
    private static class heartbeat_argsTupleScheme extends TupleScheme<heartbeat_args> {
        ...
        if (struct.isSetPrefetchedBlockIds()) {
          {
            ...
            for (long _iter42 : struct.prefetchedBlockIds)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TMap _map43 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
            struct.usedBytesOnTiers = new HashMap<String,Long>(2*_map43.size);
            String _key44;
            long _val45;
            for (int _i46 = 0; _i46 < _map43.size; ++_i46)
            {
              ...
              struct.usedBytesOnTiers.put(_key44, _val45);
            }
          }
          struct.setUsedBytesOnTiersIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.removedBlockIds = new ArrayList<Long>(_list47.size);
            long _elem48;
            for (int _i49 = 0; _i49 < _list47.size; ++_i49)
            {
              _elem48 = iprot.readI64();
              struct.removedBlockIds.add(_elem48);
            }
          }
          struct.setRemovedBlockIdsIsSet(true);
        }
        if (incoming.get(3)) {
          {
            ...
            struct.addedBlocksOnTiers = new HashMap<String,List<Long>>(2*_map50.size);
            String _key51;
            List<Long> _val52;
            for (int _i53 = 0; _i53 < _map50.size; ++_i53)
            {
              _key51 = iprot.readString();
              {
                ...
                _val52 = new ArrayList<Long>(_list54.size);
                long _elem55;
              ...
              struct.addedBlocksOnTiers.put(_key51, _val52);
            }
          }
          struct.setAddedBlocksOnTiersIsSet(true);
        }
        if (incoming.get(4)) {
          {
            ...
            struct.prefetchedBlockIds = new ArrayList<Long>(_list57.size);
            long _elem58;
            for (int _i59 = 0; _i59 < _list57.size; ++_i59)
            {
              _elem58 = iprot.readI64();
              struct.prefetchedBlockIds.add(_elem58);
            }
          }
          struct.setPrefetchedBlockIdsIsSet(true);
        }
