...
public class FileSystemMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * 
     * @param splits the information of split *
     */
    public Map<Split,List<Long>> getSplitBlocks(PrefetchInputSplits splits) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void getSplitBlocks(PrefetchInputSplits splits, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public Map<Split,List<Long>> getSplitBlocks(PrefetchInputSplits splits) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_getSplitBlocks(splits);
      return recv_getSplitBlocks();
    }

    public void send_getSplitBlocks(PrefetchInputSplits splits) throws org.apache.thrift.TException
    {
      getSplitBlocks_args args = new getSplitBlocks_args();
      args.setSplits(splits);
      sendBase("getSplitBlocks", args);
    }

    public Map<Split,List<Long>> recv_getSplitBlocks() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      getSplitBlocks_result result = new getSplitBlocks_result();
      receiveBase(result, "getSplitBlocks");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getSplitBlocks failed: unknown result");
    }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void getSplitBlocks(PrefetchInputSplits splits, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getSplitBlocks_call method_call = new getSplitBlocks_call(splits, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getSplitBlocks_call extends org.apache.thrift.async.TAsyncMethodCall {
      private PrefetchInputSplits splits;
      public getSplitBlocks_call(PrefetchInputSplits splits, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.splits = splits;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getSplitBlocks", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getSplitBlocks_args args = new getSplitBlocks_args();
        args.setSplits(splits);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public Map<Split,List<Long>> getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getSplitBlocks();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getSplitBlocks", new getSplitBlocks());
      return processMap;
    }
    ...
    public static class getSplitBlocks<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getSplitBlocks_args> {
      public getSplitBlocks() {
        super("getSplitBlocks");
      }

      public getSplitBlocks_args getEmptyArgsInstance() {
        return new getSplitBlocks_args();
      }
      ...
      public getSplitBlocks_result getResult(I iface, getSplitBlocks_args args) throws org.apache.thrift.TException {
        getSplitBlocks_result result = new getSplitBlocks_result();
        try {
          result.success = iface.getSplitBlocks(args.splits);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class getSplitBlocks<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getSplitBlocks_args, Map<Split,List<Long>>> {
      public getSplitBlocks() {
        super("getSplitBlocks");
      }
      ...
      public AsyncMethodCallback<Map<Split,List<Long>>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<Map<Split,List<Long>>>() { 
          public void onComplete(Map<Split,List<Long>> o) {
            getSplitBlocks_result result = new getSplitBlocks_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getSplitBlocks_args args, org.apache.thrift.async.AsyncMethodCallback<Map<Split,List<Long>>> resultHandler) throws TException {
        iface.getSplitBlocks(args.splits,resultHandler);
      }
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<FileBlockInfo>(_list98.size);
                  FileBlockInfo _elem99;
                  for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                  {
                    _elem99 = new FileBlockInfo();
                    _elem99.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFileBlockInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (FileBlockInfo _iter101 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (FileBlockInfo _iter102 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<FileBlockInfo>(_list103.size);
            FileBlockInfo _elem104;
            for (int _i105 = 0; _i105 < _list103.size; ++_i105)
            {
              _elem104 = new FileBlockInfo();
              _elem104.read(iprot);
...
;
    ...
    private static class listStatus_resultStandardScheme extends StandardScheme<listStatus_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<FileInfo>(_list106.size);
                  FileInfo _elem107;
                  for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                  {
                    _elem107 = new FileInfo();
                    _elem107.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listStatus_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (FileInfo _iter109 : struct.success)
            {
    ...
    private static class listStatus_resultTupleScheme extends TupleScheme<listStatus_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listStatus_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (FileInfo _iter110 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<FileInfo>(_list111.size);
            FileInfo _elem112;
            for (int _i113 = 0; _i113 < _list111.size; ++_i113)
            {
              _elem112 = new FileInfo();
              _elem112.read(iprot);
  ...
  public static class getSplitBlocks_args implements org.apache.thrift.TBase<getSplitBlocks_args, getSplitBlocks_args._Fields>, java.io.Serializable, Cloneable, Comparable<getSplitBlocks_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getSplitBlocks_args");

    private static final org.apache.thrift.protocol.TField SPLITS_FIELD_DESC = new org.apache.thrift.protocol.TField("splits", org.apache.thrift.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getSplitBlocks_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getSplitBlocks_argsTupleSchemeFactory());
    }

    private PrefetchInputSplits splits; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      /**
       * the information of split *
       */
    ...
    static {
      ...
      tmpMap.put(_Fields.SPLITS, new org.apache.thrift.meta_data.FieldMetaData("splits", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, PrefetchInputSplits.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getSplitBlocks_args.class, metaDataMap);
    }

    public getSplitBlocks_args() {
    }

    public getSplitBlocks_args(
      PrefetchInputSplits splits)
    {
      this();
      this.splits = splits;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getSplitBlocks_args(getSplitBlocks_args other) {
      if (other.isSetSplits()) {
        this.splits = new PrefetchInputSplits(other.splits);
      }
    }

    public getSplitBlocks_args deepCopy() {
      return new getSplitBlocks_args(this);
    }
     ...
     * the information of split *
     */
    public PrefetchInputSplits getSplits() {
      return this.splits;
    }
     ...
     * the information of split *
     */
    public getSplitBlocks_args setSplits(PrefetchInputSplits splits) {
      this.splits = splits;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SPLITS:
        if (value == null) {
          ...
          setSplits((PrefetchInputSplits)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getSplitBlocks_args)
        return this.equals((getSplitBlocks_args)that);
      return false;
    }

    public boolean equals(getSplitBlocks_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getSplitBlocks_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSplitBlocks_args(");
      boolean first = true;
    ...
    private static class getSplitBlocks_argsStandardSchemeFactory implements SchemeFactory {
      public getSplitBlocks_argsStandardScheme getScheme() {
        return new getSplitBlocks_argsStandardScheme();
      }
    }

    private static class getSplitBlocks_argsStandardScheme extends StandardScheme<getSplitBlocks_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getSplitBlocks_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SPLITS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.splits = new PrefetchInputSplits();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getSplitBlocks_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getSplitBlocks_argsTupleSchemeFactory implements SchemeFactory {
      public getSplitBlocks_argsTupleScheme getScheme() {
        return new getSplitBlocks_argsTupleScheme();
      }
    }

    private static class getSplitBlocks_argsTupleScheme extends TupleScheme<getSplitBlocks_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getSplitBlocks_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getSplitBlocks_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.splits = new PrefetchInputSplits();
  ...
  public static class getSplitBlocks_result implements org.apache.thrift.TBase<getSplitBlocks_result, getSplitBlocks_result._Fields>, java.io.Serializable, Cloneable, Comparable<getSplitBlocks_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getSplitBlocks_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getSplitBlocks_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getSplitBlocks_resultTupleSchemeFactory());
    }

    private Map<Split,List<Long>> success; // required
    private alluxio.thrift.AlluxioTException e; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Split.class), 
              new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
                  new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)))));
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getSplitBlocks_result.class, metaDataMap);
    }

    public getSplitBlocks_result() {
    }

    public getSplitBlocks_result(
      Map<Split,List<Long>> success,
      alluxio.thrift.AlluxioTException e)
    {
      this();
      this.success = success;
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getSplitBlocks_result(getSplitBlocks_result other) {
      if (other.isSetSuccess()) {
        Map<Split,List<Long>> __this__success = new HashMap<Split,List<Long>>(other.success.size());
        for (Map.Entry<Split, List<Long>> other_element : other.success.entrySet()) {

          Split other_element_key = other_element.getKey();
          List<Long> other_element_value = other_element.getValue();

          Split __this__success_copy_key = new Split(other_element_key);
    ...
    public getSplitBlocks_result deepCopy() {
      return new getSplitBlocks_result(this);
    }
    ...
    public void putToSuccess(Split key, List<Long> val) {
      if (this.success == null) {
        this.success = new HashMap<Split,List<Long>>();
      }
      this.success.put(key, val);
    }

    public Map<Split,List<Long>> getSuccess() {
      return this.success;
    }

    public getSplitBlocks_result setSuccess(Map<Split,List<Long>> success) {
      this.success = success;
      return this;
    }
    ...
    public getSplitBlocks_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((Map<Split,List<Long>>)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getSplitBlocks_result)
        return this.equals((getSplitBlocks_result)that);
      return false;
    }

    public boolean equals(getSplitBlocks_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getSplitBlocks_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSplitBlocks_result(");
      boolean first = true;
    ...
    private static class getSplitBlocks_resultStandardSchemeFactory implements SchemeFactory {
      public getSplitBlocks_resultStandardScheme getScheme() {
        return new getSplitBlocks_resultStandardScheme();
      }
    }

    private static class getSplitBlocks_resultStandardScheme extends StandardScheme<getSplitBlocks_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getSplitBlocks_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.success = new HashMap<Split,List<Long>>(2*_map114.size);
                  Split _key115;
                  List<Long> _val116;
                  for (int _i117 = 0; _i117 < _map114.size; ++_i117)
                  {
                    ...
                    _key115.read(iprot);
                    {
                      ...
                      _val116 = new ArrayList<Long>(_list118.size);
                      long _elem119;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getSplitBlocks_result struct) throws org.apache.thrift.TException {
        struct.validate();
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Split, List<Long>> _iter121 : struct.success.entrySet())
            {
    ...
    private static class getSplitBlocks_resultTupleSchemeFactory implements SchemeFactory {
      public getSplitBlocks_resultTupleScheme getScheme() {
        return new getSplitBlocks_resultTupleScheme();
      }
    }

    private static class getSplitBlocks_resultTupleScheme extends TupleScheme<getSplitBlocks_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getSplitBlocks_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Map.Entry<Split, List<Long>> _iter123 : struct.success.entrySet())
            {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getSplitBlocks_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map125 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
            struct.success = new HashMap<Split,List<Long>>(2*_map125.size);
            Split _key126;
            List<Long> _val127;
