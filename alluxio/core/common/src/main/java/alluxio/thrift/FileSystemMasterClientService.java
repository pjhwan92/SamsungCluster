...
public class FileSystemMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * 
     * @param isPartitionSize partition size or not
     */
    public void prefetch(String path, long numPartitions, boolean isPartitionSize) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
     ...
     * @param isPartitionSize partition size or not
     */
    public void createSplits(String path, long numPartitions, boolean isPartitionSize) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void prefetch(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void createSplits(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public void prefetch(String path, long numPartitions, boolean isPartitionSize) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_prefetch(path, numPartitions, isPartitionSize);
      recv_prefetch();
    }

    public void send_prefetch(String path, long numPartitions, boolean isPartitionSize) throws org.apache.thrift.TException
    {
      prefetch_args args = new prefetch_args();
      args.setPath(path);
      args.setNumPartitions(numPartitions);
      args.setIsPartitionSize(isPartitionSize);
      sendBase("prefetch", args);
    }

    public void recv_prefetch() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
    ...
    public void createSplits(String path, long numPartitions, boolean isPartitionSize) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_createSplits(path, numPartitions, isPartitionSize);
      recv_createSplits();
    }

    public void send_createSplits(String path, long numPartitions, boolean isPartitionSize) throws org.apache.thrift.TException
    {
    ...
    public void recv_createSplits() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void prefetch(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      prefetch_call method_call = new prefetch_call(path, numPartitions, isPartitionSize, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class prefetch_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private boolean isPartitionSize;
      public prefetch_call(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
        this.numPartitions = numPartitions;
        this.isPartitionSize = isPartitionSize;
      }
    ...
    public void createSplits(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      createSplits_call method_call = new createSplits_call(path, numPartitions, isPartitionSize, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class createSplits_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String path;
      private long numPartitions;
      private boolean isPartitionSize;
      public createSplits_call(String path, long numPartitions, boolean isPartitionSize, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.path = path;
        this.numPartitions = numPartitions;
        this.isPartitionSize = isPartitionSize;
      ...
      public void getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_createSplits();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class prefetch<I extends Iface> extends org.apache.thrift.ProcessFunction<I, prefetch_args> {
      ...
      public prefetch_result getResult(I iface, prefetch_args args) throws org.apache.thrift.TException {
        prefetch_result result = new prefetch_result();
        try {
          iface.prefetch(args.path, args.numPartitions, args.isPartitionSize);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
    ...
    public static class createSplits<I extends Iface> extends org.apache.thrift.ProcessFunction<I, createSplits_args> {
      ...
      public createSplits_result getResult(I iface, createSplits_args args) throws org.apache.thrift.TException {
        createSplits_result result = new createSplits_result();
        try {
          iface.createSplits(args.path, args.numPartitions, args.isPartitionSize);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class prefetch<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, prefetch_args, Void> {
      ...
      public void start(I iface, prefetch_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.prefetch(args.path, args.numPartitions, args.isPartitionSize,resultHandler);
      }
    }
    ...
    public static class createSplits<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, createSplits_args, Void> {
      ...
      public void start(I iface, createSplits_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.createSplits(args.path, args.numPartitions, args.isPartitionSize,resultHandler);
      }
    }
...
;
  ...
  public static class prefetch_args implements org.apache.thrift.TBase<prefetch_args, prefetch_args._Fields>, java.io.Serializable, Cloneable, Comparable<prefetch_args>   {
    ...
    private static final org.apache.thrift.protocol.TField IS_PARTITION_SIZE_FIELD_DESC = new org.apache.thrift.protocol.TField("isPartitionSize", org.apache.thrift.protocol.TType.BOOL, (short)3);
    ...
    private boolean isPartitionSize; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      ...
      /**
       * partition size or not
       */
      IS_PARTITION_SIZE((short)3, "isPartitionSize");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          ...
          case 3: // IS_PARTITION_SIZE
            return IS_PARTITION_SIZE;
          default:
            return null;
        }
      }
    ...
    private static final int __ISPARTITIONSIZE_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.NUM_PARTITIONS, new org.apache.thrift.meta_data.FieldMetaData("numPartitions", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      tmpMap.put(_Fields.IS_PARTITION_SIZE, new org.apache.thrift.meta_data.FieldMetaData("isPartitionSize", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public prefetch_args(prefetch_args other) {
      ...
      this.isPartitionSize = other.isPartitionSize;
    }
    ...
    public void clear() {
      ...
      setIsPartitionSizeIsSet(false);
      this.isPartitionSize = false;
    }
     ...
     * the path of the file
     */
    public prefetch_args setPath(String path) {
      this.path = path;
      return this;
    }
     ...
     * the number of partitions
     */
    public prefetch_args setNumPartitions(long numPartitions) {
      this.numPartitions = numPartitions;
      setNumPartitionsIsSet(true);
      return this;
    }
    ...
    public void unsetNumPartitions() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMPARTITIONS_ISSET_ID);
    }
    ...
    public boolean isSetNumPartitions() {
      return EncodingUtils.testBit(__isset_bitfield, __NUMPARTITIONS_ISSET_ID);
    }

    public void setNumPartitionsIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMPARTITIONS_ISSET_ID, value);
    }

    /**
     * partition size or not
     */
    public boolean isIsPartitionSize() {
      return this.isPartitionSize;
    }

    /**
     * partition size or not
     */
    public prefetch_args setIsPartitionSize(boolean isPartitionSize) {
      this.isPartitionSize = isPartitionSize;
      setIsPartitionSizeIsSet(true);
      return this;
    }

    public void unsetIsPartitionSize() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISPARTITIONSIZE_ISSET_ID);
    }

    /** Returns true if field isPartitionSize is set (has been assigned a value) and false otherwise */
    public boolean isSetIsPartitionSize() {
      return EncodingUtils.testBit(__isset_bitfield, __ISPARTITIONSIZE_ISSET_ID);
    }

    public void setIsPartitionSizeIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISPARTITIONSIZE_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case NUM_PARTITIONS:
        if (value == null) {
          ...
          setNumPartitions((Long)value);
        }
        break;

      case IS_PARTITION_SIZE:
        if (value == null) {
          unsetIsPartitionSize();
        } else {
          setIsPartitionSize((Boolean)value);
        }
        break;
    ...
    public boolean equals(prefetch_args that) {
      ...
      boolean this_present_isPartitionSize = true;
      boolean that_present_isPartitionSize = true;
      if (this_present_isPartitionSize || that_present_isPartitionSize) {
        if (!(this_present_isPartitionSize && that_present_isPartitionSize))
          return false;
        if (this.isPartitionSize != that.isPartitionSize)
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_numPartitions = true;
      list.add(present_numPartitions);
      if (present_numPartitions)
        list.add(numPartitions);

      boolean present_isPartitionSize = true;
      list.add(present_isPartitionSize);
      if (present_isPartitionSize)
        list.add(isPartitionSize);
    ...
    public int compareTo(prefetch_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetNumPartitions()).compareTo(other.isSetNumPartitions());
      if (lastComparison != 0) {
        return lastComparison;
      }
      ...
      lastComparison = Boolean.valueOf(isSetIsPartitionSize()).compareTo(other.isSetIsPartitionSize());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetIsPartitionSize()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.isPartitionSize, other.isPartitionSize);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("isPartitionSize:");
      sb.append(this.isPartitionSize);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class prefetch_argsStandardScheme extends StandardScheme<prefetch_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, prefetch_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 3: // IS_PARTITION_SIZE
              if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
                struct.isPartitionSize = iprot.readBool();
                struct.setIsPartitionSizeIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, prefetch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldEnd();
        oprot.writeFieldBegin(IS_PARTITION_SIZE_FIELD_DESC);
        oprot.writeBool(struct.isPartitionSize);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
    ...
    private static class prefetch_argsTupleScheme extends TupleScheme<prefetch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, prefetch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetIsPartitionSize()) {
          optionals.set(2);
        }
        oprot.writeBitSet(optionals, 3);
        if (struct.isSetPath()) {
  ...
  public static class prefetch_result implements org.apache.thrift.TBase<prefetch_result, prefetch_result._Fields>, java.io.Serializable, Cloneable, Comparable<prefetch_result>   {
    ...
    public prefetch_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
  ...
  public static class createSplits_args implements org.apache.thrift.TBase<createSplits_args, createSplits_args._Fields>, java.io.Serializable, Cloneable, Comparable<createSplits_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new createSplits_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new createSplits_argsTupleSchemeFactory());
    }
     ...
     * the path of the file
     */
    public createSplits_args setPath(String path) {
      this.path = path;
      return this;
    }
     ...
     * the number of partitions
     */
    public createSplits_args setNumPartitions(long numPartitions) {
      this.numPartitions = numPartitions;
      setNumPartitionsIsSet(true);
      return this;
    }
     ...
     * partition size or not
     */
    public createSplits_args setIsPartitionSize(boolean isPartitionSize) {
      this.isPartitionSize = isPartitionSize;
      setIsPartitionSizeIsSet(true);
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("createSplits_args(");
      boolean first = true;
    ...
    private static class createSplits_argsStandardSchemeFactory implements SchemeFactory {
      public createSplits_argsStandardScheme getScheme() {
        return new createSplits_argsStandardScheme();
      }
    }

    private static class createSplits_argsStandardScheme extends StandardScheme<createSplits_args> {
    ...
    private static class createSplits_argsTupleSchemeFactory implements SchemeFactory {
      public createSplits_argsTupleScheme getScheme() {
        return new createSplits_argsTupleScheme();
      }
    }

    private static class createSplits_argsTupleScheme extends TupleScheme<createSplits_args> {
  ...
  public static class createSplits_result implements org.apache.thrift.TBase<createSplits_result, createSplits_result._Fields>, java.io.Serializable, Cloneable, Comparable<createSplits_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new createSplits_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new createSplits_resultTupleSchemeFactory());
    }
    ...
    public createSplits_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("createSplits_result(");
      boolean first = true;
    ...
    private static class createSplits_resultStandardSchemeFactory implements SchemeFactory {
      public createSplits_resultStandardScheme getScheme() {
        return new createSplits_resultStandardScheme();
      }
    }

    private static class createSplits_resultStandardScheme extends StandardScheme<createSplits_result> {
    ...
    private static class createSplits_resultTupleSchemeFactory implements SchemeFactory {
      public createSplits_resultTupleScheme getScheme() {
        return new createSplits_resultTupleScheme();
      }
    }

    private static class createSplits_resultTupleScheme extends TupleScheme<createSplits_result> {
