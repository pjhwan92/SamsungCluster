...
public class BlockMasterClientService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * Added by pjh.
     * 
     * @param metas the list of prefetching data
     */
    public void prefetchSplit(List<alluxio.thrift.PrefetchFromTo> metas) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void prefetchSplit(List<alluxio.thrift.PrefetchFromTo> metas, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public void prefetchSplit(List<alluxio.thrift.PrefetchFromTo> metas) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_prefetchSplit(metas);
      recv_prefetchSplit();
    }

    public void send_prefetchSplit(List<alluxio.thrift.PrefetchFromTo> metas) throws org.apache.thrift.TException
    {
      prefetchSplit_args args = new prefetchSplit_args();
      args.setMetas(metas);
      sendBase("prefetchSplit", args);
    }

    public void recv_prefetchSplit() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      prefetchSplit_result result = new prefetchSplit_result();
      receiveBase(result, "prefetchSplit");
      if (result.e != null) {
        throw result.e;
      }
      return;
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void prefetchSplit(List<alluxio.thrift.PrefetchFromTo> metas, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      prefetchSplit_call method_call = new prefetchSplit_call(metas, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class prefetchSplit_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<alluxio.thrift.PrefetchFromTo> metas;
      public prefetchSplit_call(List<alluxio.thrift.PrefetchFromTo> metas, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.metas = metas;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("prefetchSplit", org.apache.thrift.protocol.TMessageType.CALL, 0));
        prefetchSplit_args args = new prefetchSplit_args();
        args.setMetas(metas);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public void getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_prefetchSplit();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("prefetchSplit", new prefetchSplit());
    ...
    public static class prefetchSplit<I extends Iface> extends org.apache.thrift.ProcessFunction<I, prefetchSplit_args> {
      public prefetchSplit() {
        super("prefetchSplit");
      }

      public prefetchSplit_args getEmptyArgsInstance() {
        return new prefetchSplit_args();
      }
      ...
      public prefetchSplit_result getResult(I iface, prefetchSplit_args args) throws org.apache.thrift.TException {
        prefetchSplit_result result = new prefetchSplit_result();
        try {
          iface.prefetchSplit(args.metas);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class prefetchSplit<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, prefetchSplit_args, Void> {
      public prefetchSplit() {
        super("prefetchSplit");
      }
      ...
      public void start(I iface, prefetchSplit_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.prefetchSplit(args.metas,resultHandler);
      }
    }
...
;
  ...
  public static class prefetchSplit_args implements org.apache.thrift.TBase<prefetchSplit_args, prefetchSplit_args._Fields>, java.io.Serializable, Cloneable, Comparable<prefetchSplit_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("prefetchSplit_args");

    private static final org.apache.thrift.protocol.TField METAS_FIELD_DESC = new org.apache.thrift.protocol.TField("metas", org.apache.thrift.protocol.TType.LIST, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new prefetchSplit_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new prefetchSplit_argsTupleSchemeFactory());
    }

    private List<alluxio.thrift.PrefetchFromTo> metas; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      /**
       * the list of prefetching data
       */
      METAS((short)1, "metas");
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.METAS, new org.apache.thrift.meta_data.FieldMetaData("metas", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, alluxio.thrift.PrefetchFromTo.class))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(prefetchSplit_args.class, metaDataMap);
    }

    public prefetchSplit_args() {
    }

    public prefetchSplit_args(
      List<alluxio.thrift.PrefetchFromTo> metas)
    {
      this();
      this.metas = metas;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public prefetchSplit_args(prefetchSplit_args other) {
      if (other.isSetMetas()) {
        List<alluxio.thrift.PrefetchFromTo> __this__metas = new ArrayList<alluxio.thrift.PrefetchFromTo>(other.metas.size());
        for (alluxio.thrift.PrefetchFromTo other_element : other.metas) {
          __this__metas.add(new alluxio.thrift.PrefetchFromTo(other_element));
        }
        this.metas = __this__metas;
      }
    }

    public prefetchSplit_args deepCopy() {
      return new prefetchSplit_args(this);
    }
    ...
    public java.util.Iterator<alluxio.thrift.PrefetchFromTo> getMetasIterator() {
      return (this.metas == null) ? null : this.metas.iterator();
    }

    public void addToMetas(alluxio.thrift.PrefetchFromTo elem) {
      if (this.metas == null) {
        this.metas = new ArrayList<alluxio.thrift.PrefetchFromTo>();
      }
      this.metas.add(elem);
    }
     ...
     * the list of prefetching data
     */
    public List<alluxio.thrift.PrefetchFromTo> getMetas() {
      return this.metas;
    }
     ...
     * the list of prefetching data
     */
    public prefetchSplit_args setMetas(List<alluxio.thrift.PrefetchFromTo> metas) {
      this.metas = metas;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case METAS:
        if (value == null) {
          ...
          setMetas((List<alluxio.thrift.PrefetchFromTo>)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof prefetchSplit_args)
        return this.equals((prefetchSplit_args)that);
      return false;
    }

    public boolean equals(prefetchSplit_args that) {
      if (that == null)
        return false;
    ...
    public int hashCode() {
      ...
      boolean present_metas = true && (isSetMetas());
      list.add(present_metas);
      if (present_metas)
        list.add(metas);
    ...
    @Override
    public int compareTo(prefetchSplit_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
      ...
      lastComparison = Boolean.valueOf(isSetMetas()).compareTo(other.isSetMetas());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetMetas()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("prefetchSplit_args(");
      boolean first = true;
    ...
    private static class prefetchSplit_argsStandardSchemeFactory implements SchemeFactory {
      public prefetchSplit_argsStandardScheme getScheme() {
        return new prefetchSplit_argsStandardScheme();
      }
    }

    private static class prefetchSplit_argsStandardScheme extends StandardScheme<prefetchSplit_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, prefetchSplit_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metas = new ArrayList<alluxio.thrift.PrefetchFromTo>(_list0.size);
                  alluxio.thrift.PrefetchFromTo _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new alluxio.thrift.PrefetchFromTo();
                    _elem1.read(iprot);
                    struct.metas.add(_elem1);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, prefetchSplit_args struct) throws org.apache.thrift.TException {
        struct.validate();
        ...
        if (struct.metas != null) {
          oprot.writeFieldBegin(METAS_FIELD_DESC);
          {
            ...
            for (alluxio.thrift.PrefetchFromTo _iter3 : struct.metas)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class prefetchSplit_argsTupleSchemeFactory implements SchemeFactory {
      public prefetchSplit_argsTupleScheme getScheme() {
        return new prefetchSplit_argsTupleScheme();
      }
    }

    private static class prefetchSplit_argsTupleScheme extends TupleScheme<prefetchSplit_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, prefetchSplit_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        ...
        if (struct.isSetMetas()) {
          {
            ...
            for (alluxio.thrift.PrefetchFromTo _iter4 : struct.metas)
            {
              _iter4.write(oprot);
            }
          }
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, prefetchSplit_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.metas = new ArrayList<alluxio.thrift.PrefetchFromTo>(_list5.size);
            alluxio.thrift.PrefetchFromTo _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new alluxio.thrift.PrefetchFromTo();
              _elem6.read(iprot);
              struct.metas.add(_elem6);
            }
          }
          struct.setMetasIsSet(true);
        }
  ...
  public static class prefetchSplit_result implements org.apache.thrift.TBase<prefetchSplit_result, prefetchSplit_result._Fields>, java.io.Serializable, Cloneable, Comparable<prefetchSplit_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("prefetchSplit_result");

    private static final org.apache.thrift.protocol.TField E_FIELD_DESC = new org.apache.thrift.protocol.TField("e", org.apache.thrift.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new prefetchSplit_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new prefetchSplit_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(prefetchSplit_result.class, metaDataMap);
    }

    public prefetchSplit_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public prefetchSplit_result(prefetchSplit_result other) {
      if (other.isSetE()) {
        this.e = new alluxio.thrift.AlluxioTException(other.e);
      }
    }

    public prefetchSplit_result deepCopy() {
      return new prefetchSplit_result(this);
    }
    ...
    public prefetchSplit_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof prefetchSplit_result)
        return this.equals((prefetchSplit_result)that);
      return false;
    }

    public boolean equals(prefetchSplit_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(prefetchSplit_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("prefetchSplit_result(");
      boolean first = true;
    ...
    private static class prefetchSplit_resultStandardSchemeFactory implements SchemeFactory {
      public prefetchSplit_resultStandardScheme getScheme() {
        return new prefetchSplit_resultStandardScheme();
      }
    }

    private static class prefetchSplit_resultStandardScheme extends StandardScheme<prefetchSplit_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, prefetchSplit_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, prefetchSplit_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class prefetchSplit_resultTupleSchemeFactory implements SchemeFactory {
      public prefetchSplit_resultTupleScheme getScheme() {
        return new prefetchSplit_resultTupleScheme();
      }
    }

    private static class prefetchSplit_resultTupleScheme extends TupleScheme<prefetchSplit_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, prefetchSplit_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetE()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, prefetchSplit_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.e = new alluxio.thrift.AlluxioTException();
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<WorkerInfo>(_list8.size);
                  WorkerInfo _elem9;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getWorkerInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (WorkerInfo _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (WorkerInfo _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<WorkerInfo>(_list13.size);
            WorkerInfo _elem14;
